...
function createUserSettingsStore() {
  ...
  return {
     ...
     */
    async updateSettings(updates: { language?: string; locale?: string; first_day_of_week?: 'sunday' | 'monday'; statistics_email_frequency?: 'none' | 'weekly' | 'monthly'; setup_completed?: boolean }) {
